---
title: "microstegium-elymus-model-summary"
author: "Amy Kendig"
date: "10/15/2019"
output: pdf_document
---
...
# import data
params <- read_csv("../data/mv_ev_model_parameters_101519.csv", col_types = cols())
...
L[t+1] = b * c.a * g.a * h.a * f.a * N.a[t-1] + b * L[t]  
...
simFun = function(params, N0.a, N0.s, N0.p, L0, Ni.a, simtime){
  ...
  for(t in 1:(simtime-1)){	
    ...
    N.p[t+1]=m.p*N.p[t]+g.s*h.s*N.s[t]
    N.a[t+1]=s.a*(1-g.a)*N.a[t]+g.a*h.a*f.a*N.a[t]
    L[t+1]=ifelse(t > 2, b*c.a*g.a*h.a*f.a*N.a[t-1]+b*L[t], L0)
