...
## left off here ##
# seed production competition parameters (experiment)
alpha.aa=496/lambda.a
alpha.as=715/lambda.a
alpha.ap=977/lambda.a

alpha.pa=46/lambda.p
alpha.ps=63/lambda.p
alpha.pp=53/lambda.p

alpha.sa=0.091
alpha.ss=alpha.as
alpha.sp=alpha.as*10
