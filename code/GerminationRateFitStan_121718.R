...
ggplot(mvDat,aes(x=Litter.g,y=CorGermMv/50))+geom_point()+geom_line(data=mvDat_pred,aes(x=Litter.g,y=pred))
+

evDat$pred=ev_g/(1+ev_a*evDat$Litter.g)
ggplot(evDat,aes(x=Litter.g,y=NewGermEv/50))+geom_point()+geom_line(aes(y=pred))
