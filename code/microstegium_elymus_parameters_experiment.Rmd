...
g.A_parms <- filter(A_germ_est, parm == "max_germ_autoclaved") %>%
...
# select the no-litter values
beta.A_parms <- filter(A_germ_est, parm == "alpha_autoclaved")
...
```{r y.A, out.width = "50%"}
# import model
load("../../big-oaks-field-experiment-2018-2019/microstegium-bipolaris/output/mv_seeds_per_biomass_model_2018_2019_density_exp.rda")

# look at coefficients
summary(mv_seed_bio_mod)

# manually add up relevant coefficients (biomass, year2:biomass, fungicide:biomass, year2:fungicide:biomass)
(y.A0 <- 10.264 + 74.136 + 4.905 - 12.440)
```
...
```{r y.SP, out.width = "50%"}
# import model
load("../../big-oaks-field-experiment-2018-2019/microstegium-bipolaris/output/ev_seeds_per_biomass_model_2019_density_exp.rda")

# look at coefficients
summary(ev_seed_bio_mod)

# manually add up relevant coefficients (biomass, age:biomass, fungicide:biomass, age:fungicide:biomass)
(y.S0 <- 18.6107 - 12.2603 + 3.6171 - 2.3515)
(y.P0 <- 18.6107 + 3.6171)
