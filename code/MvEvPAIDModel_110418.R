...
# plot (intraC is intentionally entered wrong to get intended order in figure)
dfdI4b=data.frame(N=c(NdH.ev4b,NdH.mv4b),time=rep(1:simtime,2),species=rep(c("Ev","Mv"),each=simtime),intraC=10)
...
pdf("MvEvPAIDModel_110418.pdf",width=9,height=5.5)
