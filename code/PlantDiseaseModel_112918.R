# Method for specifying infection is a little problematic with Mv doesn't invade system. Similar outcomes across a range of parameter values - how to collapse?
...
compFun=function(germ.a,germ.s,lambda.a,lambda.p,s.a,alpha.aa,alpha.ss,alpha.pp,alpha.as,alpha.ap,alpha.sa,alpha.pa,alpha.ps,s.p,simtime,N0.a,N0.s,N0.p,lambdaI.a,lambdaI.p){
	...
	# max invasive population in the absence of disease
	K.a=ifelse(Nh.a[simtime]>0,Nh.a[simtime],1e-6)
...
pdf("PlantDiseaseModel_112918.pdf")
